      ...
      <div className="reply-comment style-1 cancel-review-wrap">
        ...
        <div className="reply-comment-wrap">
          ...
          <div className="reply-comment-item type-reply">
            <div className="user">
              <div className="image">
                <Image alt="" src="/images/avatar/user-Suellen Flores.jpg" width={104} height={104} />
              </div>
              <div>
                <h6>
                  <a href="#" className="link">
                    Reply from Suellen Flores
                  </a>
                </h6>
                <div className="day text-secondary-2 text-caption-1">1 days ago &nbsp;&nbsp;&nbsp;-</div>
              </div>
            </div>
            <p className="text-secondary">We love to hear it! Part of what we love most about Suellen Flores is how much it empowers store owners like yourself to build a beautiful website without having to hire a developer :) Thank you for this fantastic review!</p>
          </div>
          <div className="reply-comment-item">
            <div className="user">
              <div className="image">
